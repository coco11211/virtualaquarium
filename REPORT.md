...
A fourth near-miss: index calculus at `k=6` fits a **total** exponent below 0.5 on toy
...
| 3 · `j=0` / CM | automorphism-invariant predicates; cubic character; xedni on CM curves | `ρ = 1.002`; 0/1080 dependent lifts | **DEAD** |
